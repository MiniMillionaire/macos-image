...
source "tart-cli" "tahoe" {
  ...
  boot_command = [
    ...
    "<wait10s><leftShiftOn><tab><leftShiftOff><spacebar>",
    "<wait10s><leftShiftOn><tab><leftShiftOff><spacebar>",
    "<wait10s><tab><tab><tab><tab><tab><tab>CI User<tab>${var.guest_username}<tab>${var.guest_password}<tab>${var.guest_password}<tab><tab><spacebar><tab><tab><spacebar>",
    ...
    "<wait120s><leftCtrlOn><f2><leftCtrlOff><right><right><right><down>Sharing<enter>",
    ...
    "<wait10s>${var.guest_password}<enter>",
    "<wait10s>open '/System/Applications/System Settings.app'<enter>",
    "<wait120s><leftCtrlOn><f2><leftCtrlOff><right><right><right><down>Privacy & Security<enter>",
